...
class ImageManager {
  //Splash Screen
  static const splash = "${path}logo.png";
  static const printLogo = "${path}printLogo.jpg";
  //onboardingScreen
  ...
  static const String womenTshirt = "${path}women_tshirt.jpg";
  static const String womenPants = "${path}women_pants.jpg";
}
